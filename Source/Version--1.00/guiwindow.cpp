...
void guiWindow::PortsSearch()
{
    ...
    if(serialFoundList.isEmpty()) {
        ...
        PopupWindow("No devices detected!", "Is the microcontroller board currently running P.I.G.S and is currently plugged in? Make sure it's connected and recognized by the PC.\n\nP.I.G.S GUI will now close.", "ERROR", 4);
        exit(1);
    } else {
        ...
        if(!usbName.length()) {
            PopupWindow("No P.I.G.S devices detected!", "Is the microcontroller board currently running P.I.G.S and is currently plugged in? Make sure it's connected and recognized by the PC.\nP.I.G.S-GUI only supports firmwares starting from v4.0 \"L.G.A Force\" and onwards.\n\P.I.G.S-GUI will now close.", "ERROR", 4);
            exit(1);
        }
    }
}
